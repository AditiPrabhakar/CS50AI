...
class MinesweeperAI:
    ...
    def add_knowledge(self, cell, count):
        ...
        # 3) add a new sentence to the AI's knowlegde base based on value of `cell` and `count`.
        # basically count here is number of safe cells out there, if we find a mine that would decrease it's count.
        neighbors = set()
                ...
                if s1.cells.issubset(s2.cells):
                    ...
                    if diff_cells and diff_count >= 0:
                        ...
                        if (
                            ...
                            and new_s not in new_sentences
                            and new_s
                        ):
                            new_sentences.append(new_s)

            if new_sentences:
                for a in new_sentences:
    ...
    def mark_cells(self):
        ...
        for k_safe in safes:
            self.mark_safe(k_safe)
        for k_mine in mines:
            self.mark_mine(k_mine)
